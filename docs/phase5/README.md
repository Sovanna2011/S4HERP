...
| Browser acceptance (81 checks) | The UI journeys, in Chromium against the real API | `ui5/test/ui-acceptance.mjs` |

**529 automated checks**, all passing. Every one asserts a *specific* outcome —
